...
> 项目功能完成度详情、待开发项台账、稳定性验证状态等内部文档已独立维护，不在此公开文档中引用。
...
| 测试基线 | 单元 `672 passed / 6 skipped / 0 failed`（最新测试结果） |
...
| [RELEASE_NOTES.md](./docs/public/RELEASE_NOTES.md) | 发布说明 |
| [SECURITY.md](./SECURITY.md) | 安全政策 |
| [CONTRIBUTING.md](./CONTRIBUTING.md) | 贡献指南 |

> AI 开发规则、交接状态、开发计划、长期路线图等内部文档不对外公开，AI Agent 可通过本地文件系统访问 `docs/internal/` 目录。
